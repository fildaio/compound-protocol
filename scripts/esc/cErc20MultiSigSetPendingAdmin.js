...
module.exports = async function(callback) {
    try {
        ...
        for (market of allSupportedMarkets) {
            ...
            let setPendingAdminEncode = await cTokenInstance.contract.methods._setPendingAdmin(newAdmin).encodeABI();
            await multisigInstance.submitTransaction(cTokenInstance.address, 0, setPendingAdminEncode);
